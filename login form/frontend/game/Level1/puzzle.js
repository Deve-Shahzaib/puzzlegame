...
function dragEnd() {
   ...
   //  console.log('you have complete this puzzle  and congrats you winner')
    //document.getElementById('message').innerHTML = 'you have complete this puzzle  and congrats you winner'
    // setTimeout(() => {
